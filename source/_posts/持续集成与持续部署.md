...
![img](持续集成与持续部署.assets/1460000014924499.png)
...
![img](持续集成与持续部署.assets/c5c8e6f40c7c133e22402c00bb7e1a25_hd-6510245.jpg)
...
![img](持续集成与持续部署.assets/db7198e3c39e4656e18efcb4bd1b20b1_hd-6510245.jpg)
...
![img](持续集成与持续部署.assets/f96f19e4d567aad5006d841963a86e41_hd-6510245.jpg)
...
![DevOps](持续集成与持续部署.assets/DevOps.png)
...
![image-20190611100501785](持续集成与持续部署.assets/image-20190611100501785.png)

CirCle CI的价格：

![image-20190611100534676](持续集成与持续部署.assets/image-20190611100534676.png)
...
![image-20190611103941326](持续集成与持续部署.assets/image-20190611103941326.png)
...
![image-20190611163108298](持续集成与持续部署.assets/image-20190611163108298.png)

Jenkins的界面

![image-20190611163727975](持续集成与持续部署.assets/image-20190611163727975.png)

任务详情页面

![image-20190611163855257](持续集成与持续部署.assets/image-20190611163855257.png)
...
4. 配置Jenkins插件加速
   ...
   ![ç³»ç»ç®¡ç](持续集成与持续部署.assets/70.png)

   ![æä»¶ç®¡ç](持续集成与持续部署.assets/70-20190611152837311.png)
...
- Publish Over FTP
  ...
  ![img](持续集成与持续部署.assets/20181225153134962.jpeg)
...
![img](持续集成与持续部署.assets/3dee2f58ccdf7cf25fa86074c5485184a9f.jpg)
...
![img](持续集成与持续部署.assets/abf7ec185c847b72cd61181562f940557a2.jpg)
...
![image-20190612205411602](持续集成与持续部署.assets/image-20190612205411602.png)

这里第二步在，`Dashboard`这个选项卡中，点击`Activate`这个按钮

![image-20190612212459194](持续集成与持续部署.assets/image-20190612212459194.png)

完了之后，Dashboard会列出所有Github中有`.travis.yml`配置文件的仓库：

![image-20190612212731186](持续集成与持续部署.assets/image-20190612212731186.png)

Travis 会列出 Github 上面你的所有仓库，以及你所属于的组织。此时，选择你需要 Travis 帮你构建的仓库，打开仓库旁边的开关。一旦激活了一个仓库，Travis 会监听这个仓库的所有变化。

![image-20190612213022380](持续集成与持续部署.assets/image-20190612213022380.png)

- `Settings`中用于配置项目的构建条件

  ![image-20190612214434173](持续集成与持续部署.assets/image-20190612214434173.png)

- `Requests`可以查看构建记录

  ![image-20190612214519926](持续集成与持续部署.assets/image-20190612214519926.png)
...
![image-20190612225000955](持续集成与持续部署.assets/image-20190612225000955.png)
...
1. 注册 CircleCI
   ...
   ![image-20190613093550553](持续集成与持续部署.assets/image-20190613093550553.png)

   进行授权：

   ![image-20190613093732415](持续集成与持续部署.assets/image-20190613093732415.png)

2. 启动存储库

检查要在 CircleCI 上管理的存储库的开关按钮。

![image-20190613094115350](持续集成与持续部署.assets/image-20190613094115350.png)
...
4. 设置/查看任务
   ...
   ![image-20190613093327981](持续集成与持续部署.assets/image-20190613093327981.png)
...
![DevOps](持续集成与持续部署.assets/devops-hero-1-87966cfbc9c5713ae047551c7b22985c.png)
